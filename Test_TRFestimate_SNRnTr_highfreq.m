...
freq_range = [2 15]; % frequency range of the signals
%%% highpass cutoff of signal has higher frequency
resp_dur = 250; % duration of the response (in ms) (response starts at 0 delay)
...
save('TRFestimate_w_SNRnTr_highfreq','total_mdl','test_r','opt_lmb','circ_test_r',...
